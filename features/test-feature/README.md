...
|---|---|---|---|---|
| PDR | 1 | <!-- date --> | `pdr/test-feature/approved` | <!-- name --> |
| CDR | 1 | <!-- date --> | `cdr/test-feature/approved` | <!-- name --> |
| TRR | 1 | <!-- date --> | `test-feature-vX.Y.Z-rc.N` | <!-- name --> |
| Release | 1 | <!-- date --> | `release/test-feature/approved` | <!-- name --> |
