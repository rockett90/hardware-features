...
> Review records and sign-off evidence for `test-feature`.
...
|---|---|---|
| `gate-evidence-cdr.md` | Created automatically by CI when a `signoff/test-feature/cdr` branch is pushed | Do not edit manually |
| `gate-evidence-trr.md` | Created automatically by CI when a `signoff/test-feature/trr` branch is pushed | Do not edit manually |
| `gate-evidence-release.md` | Created automatically by CI when a `signoff/test-feature/release` branch is pushed | Do not edit manually |
| `external-references.md` | Created automatically by CI when a `signoff/test-feature/trr` branch is pushed | Populate with real SharePoint and IV&V links before release sign-off |
